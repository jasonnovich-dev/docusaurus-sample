...
const config = {
  ...
  organizationName: 'jasonnovich-dev', // Usually your GitHub org/user name.
  ...
  themeConfig:
    ...
    navbar: {
      ...
      items: [
        ...
        // API reference page, in the same left-side group as Tutorial/Blog
        // (not off in a secondary/right-side spot) -- see
        // src/pages/api-reference.js, wired up by the OAS publishing
        // pipeline's SSG_OAS_PAGE_PATH patch mode.
